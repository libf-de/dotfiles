...
dump_diagnostics_key(Key.F12)   # default key: F15
emergency_eject_key(Key.F13)    # default key: F16
...
keymap("User overrides for i3 WM", {
    ...
    C("RC-Space"):              C("Alt-D"),                   # Cmd+Space: Launcher
    # C("LA-D"):                  C("Super-D"),                   # Mod+D: Launcher
    C("RC-Enter"):              C("Alt-Enter"),               # Mod+Enter: Open terminal
    C("RC-1"):                  C("Alt-1"),
    C("RC-2"):                  C("Alt-2"),
    C("RC-3"):                  C("Alt-3"),
    C("RC-4"):                  C("Alt-4"),
    ...
    C("RC-8"):                  C("Alt-8"),
    C("RC-9"):                  C("Alt-9"),
    C("RC-Shift-1"):            C("Alt-Shift-1"),
    C("RC-Shift-2"):            C("Alt-Shift-2"),
    C("RC-Shift-3"):            C("Alt-Shift-3"),
    C("RC-Shift-4"):            C("Alt-Shift-4"),
    C("RC-Shift-5"):            C("Alt-Shift-5"),
    C("RC-Shift-6"):            C("Alt-Shift-6"),
    C("RC-Shift-7"):            C("Alt-Shift-7"),
    C("RC-Shift-8"):            C("Alt-Shift-8"),
    C("RC-Shift-9"):            C("Alt-Shift-9"),
    C("LA-1"):                  C("Super-1"),
    C("LA-2"):                  C("Super-2"),
    C("LA-3"):                  C("Super-3"),
    C("LA-4"):                  C("Super-4"),
    ...
    C("LA-8"):                  C("Super-8"),
    C("LA-9"):                  C("Super-9"),
    #C("LC-1"):                  C("Super-Shift-1"),
    #C("LC-2"):                  C("Super-Shift-2"),
...
keymap("User hardware keys", {
    ...
    C("Alt-LEFT_BRACE"):                  UC(0x00FC),
    C("Alt-Shift-LEFT_BRACE"):            UC(0x00DC),
    C("Alt-Semicolon"):                   UC(0x00F6),
    C("Alt-Shift-Semicolon"):             UC(0x00D6),
    C("Alt-Apostrophe"):                  UC(0x00E4),
    C("Alt-Shift-Apostrophe"):            UC(0x00C4),
    C("Alt-Minus"):                       UC(0x00DF),
    C("Alt-Shift-Minus"):                 UC(0x1E9E),
    C("Alt-S"):                           UC(0x00DF),
    C("Alt-Shift-S"):                     UC(0x1E9E),
}, when = lambda ctx:
    cnfg.screen_has_focus and
    matchProps(not_lst=remotes_lod)(ctx)
)
...
keymap("VSCodes", {
    ...
    C("Alt-RC-Up"):             C("Shift-C-Up"),                # Insert cursor above
    C("Alt-RC-Down"):           C("Shift-C-Down"),              # Insert cursor below
