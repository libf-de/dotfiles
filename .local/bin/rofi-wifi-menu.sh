...
CHENTRY=$(echo -e "$TOGGLE\n$SEPARATOR\0nonselectable\x1ftrue\n$LIST\n$SEPARATOR\0nonselectable\x1ftrue\nmanual" | uniq -u | rofi -dmenu -p "Wi-Fi SSID: " -lines "$LINENUM" -a "$HIGHLINE" -location 3 -yoffset 38 -xoffset -2 -theme-str "window { width: ${RWIDTH}; } configuration { show-icons: false; }")
#echo "$CHENTRY"
